...
CLK_OF_DECLARE_DRIVER(mtk_topckgen, "mediatek,mt6785-topckgen", mtk_topckgen_init);
...
CLK_OF_DECLARE_DRIVER(mtk_infracfg_ao, "mediatek,mt6785-infracfg_ao",
...
CLK_OF_DECLARE_DRIVER(mtk_apmixedsys, "mediatek,mt6785-apmixed",
		mtk_apmixedsys_init);
...
CLK_OF_DECLARE_DRIVER(mtk_audio, "mediatek,mt6785-audio", mtk_audio_init);
...
CLK_OF_DECLARE_DRIVER(mtk_camsys, "mediatek,mt6785-camsys", mtk_camsys_init);
...
CLK_OF_DECLARE_DRIVER(mtk_imgsys, "mediatek,mt6785-imgsys", mtk_imgsys_init);
...
CLK_OF_DECLARE_DRIVER(mtk_mfg_cfg, "mediatek,mt6785-mfgcfg", mtk_mfg_cfg_init);
...
CLK_OF_DECLARE_DRIVER(mtk_vdec_top_global_con, "mediatek,mt6785-vdec_gcon",
...
CLK_OF_DECLARE_DRIVER(mtk_apu_conn, "mediatek,mt6785-apu_conn", mtk_apu_conn_init);
...
CLK_OF_DECLARE_DRIVER(mtk_apu0, "mediatek,mt6785-apu0", mtk_apu0_init);
...
CLK_OF_DECLARE_DRIVER(mtk_apu1, "mediatek,mt6785-apu1", mtk_apu1_init);
...
CLK_OF_DECLARE_DRIVER(mtk_apu_vcore, "mediatek,mt6785-apu_vcore", mtk_apu_vcore_init);
